        ...
        <section id="about" className={`${classes.about} ${classes.container}`}>
            <div className={classes.about__text}>
                ...
                <motion.p
                    ...
                    viewport={fadeInUpAnim.viewport}
                >
                    Self-taught Frontend developer with three years of
                    experience. Motivated to work, eager to learn new things and
                    always giving my best. Speaking and writing English
                    fluently. Willing to constantly upgrade knowledge and make
