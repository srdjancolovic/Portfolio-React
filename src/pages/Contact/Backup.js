...
const Contact = () => {
  ...
  const nameInputClassesSuccess = nameInputIsValid
    ? classes['contact__form-input--valid']
    : classes['contact__form-input'];
  const nameInputClasses = nameInputIsInvalid
    ? classes['contact__form-input--error']
    : classes['contact__form-input'];
  ...
  const messageInputClassesSuccess = messageInputIsValid
    ? classes['contact__form-textarea--valid']
    : classes['contact__form-input'];

  const messageInputClasses = messageInputIsInvalid
    ? classes['contact__form-textarea--error']
    : classes['contact__form-input'];
    ...
    >
      ...
      <div className={classes.contact__form}>
        <form ref={form} onSubmit={sendEmailHandler}>
          <div
            className={`${classes['contact__form-input']} ${nameInputClasses} ${nameInputClassesSuccess}`}
          >
            <input
              type="text"
              placeholder={
          ...
          <div
            className={`${classes['contact__form-input']} ${emailInputClasses} ${emailInputClassesSuccess}`}
          >
            <input
              type="email"
              placeholder={
                emailInputIsInvalid ? 'Please enter valid email' : 'Your email'
              }
              name="email"
          ...
          <div
            className={`${classes['contact__form-input']} ${messageInputClasses} ${messageInputClassesSuccess}`}
          >
            <textarea
              type="text"
              placeholder={
